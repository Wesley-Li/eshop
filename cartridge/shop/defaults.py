...
register_setting(
    ...
    default=("SHOP_CARD_TYPES", "SHOP_CATEGORY_USE_FEATURED_IMAGE",
             ...
             "SHOP_USE_UPSELL_PRODUCTS","FREE_SHIPPING_TOTAL","WNI_SEARCH_PLACEHOLDER","CENTER_POTS_DICT","WITH_WEIXIN_PAY"),
    append=True,
)
...
"""
register_setting(
    name="FREE_SHIPPING_TOTAL",
    label=_("FREE SHIPPING TOTAL"),
    description=_("FREE SHIPPING FOR TOTAL"),
    editable=False,
    default="29",
)
"""