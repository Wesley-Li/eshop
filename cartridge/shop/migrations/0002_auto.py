...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field validusers on 'DiscountCode'
        m2m_table_name = db.shorten_name(u'shop_discountcode_validusers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('discountcode', models.ForeignKey(orm[u'shop.discountcode'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['discountcode_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field validusers on 'DiscountCode'
        db.delete_table(db.shorten_name(u'shop_discountcode_validusers'))
