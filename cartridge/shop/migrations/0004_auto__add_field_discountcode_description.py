...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DiscountCode.description'
        db.add_column(u'shop_discountcode', u'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DiscountCode.description'
        db.delete_column(u'shop_discountcode', u'description')
