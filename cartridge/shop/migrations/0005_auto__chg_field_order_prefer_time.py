...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.prefer_time'
        db.alter_column(u'shop_order', u'prefer_time', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'Order.prefer_time'
        db.alter_column(u'shop_order', u'prefer_time', self.gf('django.db.models.fields.DateTimeField')(null=True))
