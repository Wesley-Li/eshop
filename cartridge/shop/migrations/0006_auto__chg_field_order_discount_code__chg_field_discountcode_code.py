...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.discount_code'
        db.alter_column(u'shop_order', 'discount_code', self.gf('cartridge.shop.fields.DiscountCodeField')(max_length=40))

        # Changing field 'DiscountCode.code'
        db.alter_column(u'shop_discountcode', 'code', self.gf('cartridge.shop.fields.DiscountCodeField')(unique=True, max_length=40))

    def backwards(self, orm):

        # Changing field 'Order.discount_code'
        db.alter_column(u'shop_order', 'discount_code', self.gf('cartridge.shop.fields.DiscountCodeField')(max_length=20))

        # Changing field 'DiscountCode.code'
        db.alter_column(u'shop_discountcode', 'code', self.gf('cartridge.shop.fields.DiscountCodeField')(max_length=20, unique=True))
    ...
    models = {
        ...
        u'shop.discountcode': {
            ...
            'code': ('cartridge.shop.fields.DiscountCodeField', [], {'unique': 'True', 'max_length': '40'}),
            u'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'validusers': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "u'discountcodes'", 'blank': 'True', 'to': u"orm['auth.User']"})
        },
        u'shop.order': {
            ...
            'discount_code': ('cartridge.shop.fields.DiscountCodeField', [], {'max_length': '40', 'blank': 'True'}),
            ...
            u'prefer_time': ('django.db.models.fields.CharField', [], {'default': "'\\xe7\\xab\\x8b\\xe5\\x8d\\xb3\\xe9\\x80\\x81\\xe9\\xa4\\x90'", 'max_length': '30'}),
        ...
        u'shop.product': {
            ...
            u'recnum': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
