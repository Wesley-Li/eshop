...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.pay_type'
        db.add_column(u'shop_order', u'pay_type',
                      self.gf('django.db.models.fields.CharField')(default='\xe8\xb4\xa7\xe5\x88\xb0\xe4\xbb\x98\xe6\xac\xbe', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.pay_type'
        db.delete_column(u'shop_order', u'pay_type')
    ...
    models = {
        ...
        u'shop.order': {
            ...
            u'pay_type': ('django.db.models.fields.CharField', [], {'default': "'\\xe8\\xb4\\xa7\\xe5\\x88\\xb0\\xe4\\xbb\\x98\\xe6\\xac\\xbe'", 'max_length': '30'}),
        ...
        u'shop.productvariation': {
            ...
            u'option4': ('cartridge.shop.fields.OptionField', [], {'max_length': '50', 'null': 'True'}),
            u'option5': ('cartridge.shop.fields.OptionField', [], {'max_length': '50', 'null': 'True'}),
