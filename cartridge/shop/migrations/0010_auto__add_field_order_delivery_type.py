...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'shop_order', u'delivery_type',
                      self.gf('django.db.models.fields.CharField')(default='efoodin', max_length=60),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.delivery_type'
        db.delete_column(u'shop_order', u'delivery_type')
    ...
    models = {
        ...
        u'shop.order': {
            ...
            u'delivery_type': ('django.db.models.fields.CharField', [], {'default': "'efoodin'", 'max_length': '60'}),
