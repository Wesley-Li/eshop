...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'shop_productvariation', u'option3',
                      self.gf('cartridge.shop.fields.OptionField')(max_length=50, null=True),
                      keep_default=False)
        
        # Adding field 'Order.prefer_time'
        db.add_column(u'shop_order', u'prefer_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.saled'
        db.add_column(u'shop_product', u'saled',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Order.prefer_time'
        db.delete_column(u'shop_order', u'prefer_time')

        # Deleting field 'Product.saled'
        db.delete_column(u'shop_product', u'saled')
