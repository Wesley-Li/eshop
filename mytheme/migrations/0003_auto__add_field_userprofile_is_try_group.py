...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.is_try_group'
        db.add_column(u'mytheme_userprofile', 'is_try_group',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.is_try_group'
        db.delete_column(u'mytheme_userprofile', 'is_try_group')
    ...
    models = {
        ...
        u'mytheme.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_try_group': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'extraprofile'", 'unique': 'True', 'to': u"orm['auth.User']"})
        },
        u'pages.page': {
